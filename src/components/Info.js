...
const Info = () => {
    return(
        <div className="flex flex-wrap justify-center place-items-center bg-black w-full h-screen text-center" id="info">
            <div className="grid grid-cols-3 gap-2 tn:flex xsm:flex sm:flex tn:grid-cols-1 xsm:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3">
